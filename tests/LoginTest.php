...
{
    public function test_login_with_valid_info(){
        $this->visit('/login');
    ...
    public function test_login_with_invalid_info(){
    ...
    public function test_login_with_valid_username_only(){
        $this->visit('/login');
        $this->type('yousaf','username');
        $this->press('submit');
        $this->seePageIs('login');
    ...
    public function test_login_with_valid_password_only(){
        $this->visit('/login');
        $this->type('yousaf','password');
        $this->press('submit');
        $this->seePageIs('login');
    ...
    public function test_login_with_short_username(){
        $this->visit('/login');
